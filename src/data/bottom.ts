...
export const BOTTOM_OPTIONS: Option[] = [
  ...
  },
  {
    ...
    puzzle: {
      id: "sweatpantsPuzzle",
      prompt:
        "so many plans are in this list / they're not yet done 'cause we just kiss...",
      password: "chips",
      hint: "fragments",
      location: {
        locationText: "acebee bucket list",
        locationUrl:
          "https://docs.google.com/spreadsheets/d/11iwjCwxGhD7B4OxSROz5L04wmNa2eX9Y-CcZwErS8Gk/edit?gid=0#gid=0",
      },
    },
  },
  {
