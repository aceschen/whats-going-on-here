...
export const DRESS_OPTIONS: Option[] = [
  ...
  },
  {
	...
	puzzle: {
	  id: "bakerbeachPuzzle",
	  prompt: "it's party time, our twenty-third! / but there's an extra line, i heard?",
	  password: "baker",
	  hint: "cooks cake",
	  location: {
  ...
  },
  {
	...
	puzzle: {
	  id: "htvPuzzle",
	  prompt: "our green and orange matchmaker / has hidden something, i am sure",
	  password: "archive",
	  hint: "records",
	  location: {
  ...
  },
  {
	...
	puzzle: {
	  ...
	  prompt: "it's nice today, and late june too / i want to look at leaves with you",
	  password: "porcelain",
