...
export const ACCESSORY_OPTIONS: Option[] = [
  ...
  },
  {
    ...
    puzzle: {
      ...
      prompt: "she's pure of heart and dumb of ass / five stars for you... this book",
      password: "adhering",
      hint: "sticking to",
      location: {
  ...
  },
  {
    ...
    puzzle: {
      id: "creamsodaPuzzle",
      prompt: "i want a drink! a drink with fruit! / it's in a place where we compute",
      password: "matching",
      hint: "double",
      location: {
  ...
  },
  {
    ...
    puzzle: {
      id: "jadestarPuzzle",
      prompt: "he's asking us, 'well, what's the use?' / his site is one you should peruse",
      password: "fortune",
      hint: "wealth",
      location: {
